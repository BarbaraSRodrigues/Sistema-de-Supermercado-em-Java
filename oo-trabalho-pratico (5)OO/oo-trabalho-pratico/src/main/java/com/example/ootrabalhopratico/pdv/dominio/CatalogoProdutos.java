package com.example.ootrabalhopratico.pdv.dominio;

import com.example.ootrabalhopratico.pdv.dominio.excecoes.DescricaoProdutoInexistente;
...
public class CatalogoProdutos {
    ...
    public List<DescricaoProduto> getAllDescricaoProduto() {
